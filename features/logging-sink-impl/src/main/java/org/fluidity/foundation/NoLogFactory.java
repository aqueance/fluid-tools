...
/**
 * Log factory to produce loggers that gobble up messages. This log implementation is meant to be used when you don't want any log message actually emitted,
 * e.g., in test cases.
 *
 * @author Tibor Varga
 */
