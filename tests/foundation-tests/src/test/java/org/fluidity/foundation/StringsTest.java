...
public class StringsTest extends Simulator {
    ...
    public void nakedAnnotation() throws Exception {
        ...
        assert Objects.equals(String.format("@%s", Documented.class.getSimpleName()), string) : string;
    }
    ...
    public void plainValueAnnotation() throws Exception {
        ...
        final String string = verify(() -> Strings.describeAnnotation(false, annotation));
        assert Objects.equals(String.format("@%s(%s)", Retention.class.getSimpleName(), RetentionPolicy.RUNTIME), string) : string;
    }
    ...
    public void arrayValueAnnotation() throws Exception {
        ...
        final String string = verify(() -> Strings.describeAnnotation(false, annotation));
        assert Objects.equals(String.format("@%s({%s,%s})", Target.class.getSimpleName(), value[0], value[1]), string) : string;
    }
    ...
    public void classArrayValueAnnotation() throws Exception {
        ...
        final String string = verify(() -> Strings.describeAnnotation(false, annotation));
        assert Objects.equals(String.format("@%s.%s(Object[].class)", getClass().getSimpleName(), ClassValued.class.getSimpleName()), string) : string;
    }
    ...
    public void multiValueAnnotation() throws Exception {
        ...
        final String string = verify(() -> Strings.describeAnnotation(false, annotation));
        assert Objects.equals(String.format("@%s.%s(id=%d, list={%s,%s,%s})", getClass().getSimpleName(), MultiValued.class.getSimpleName(), id, list[0], list[1], list[2]), string) : string;
    }
    ...
    public void defaultValueAnnotation() throws Exception {
        ...
        final String string = verify(() -> Strings.describeAnnotation(false, annotation));
        assert Objects.equals(String.format("@%s.%s", getClass().getSimpleName(), MultiValued.class.getSimpleName()), string) : string;
    }
    ...
    public void testCustomAnnotationIdentity() throws Exception {
        ...
        assert Objects.equals(nirvana1, nirvana2) : String.format("%s != %s", nirvana1, nirvana2);
        ...
        assert !Objects.equals(identity1, identity2) : String.format("%s == %s", identity1, identity2);
    }
