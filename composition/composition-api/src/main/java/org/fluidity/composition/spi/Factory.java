...
public interface Factory {
  ...
  /**
   * Binds in the provided container the dependencies of the component that this is a factory for. Once this methods is called, the given container must be able
   * to successfully return an instance of the API this is a factory for.
   *
