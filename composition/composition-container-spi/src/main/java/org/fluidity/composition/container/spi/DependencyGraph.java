...
public interface DependencyGraph {
    ...
    interface Traversal {
         ...
         *
         * @param declaringType        see {@link org.fluidity.composition.ComponentContainer.Observer#resolving(Class, Class, Annotation[], Annotation[]) ComponentResolutionObserver}.
         * @param dependencyType       see {@link org.fluidity.composition.ComponentContainer.Observer#resolving(Class, Class, Annotation[], Annotation[]) ComponentResolutionObserver}.
         * @param typeAnnotations      see {@link org.fluidity.composition.ComponentContainer.Observer#resolving(Class, Class, Annotation[], Annotation[]) ComponentResolutionObserver}.
