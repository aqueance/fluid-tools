...
/**
 * Component mapping of a {@link CustomComponentFactory} class.
 *
 * @author Tibor Varga
 */
final class FactoryResolverClass extends FactoryResolver {
    ...
    public FactoryResolverClass(final int priority,
        ...
        super(priority, api, factoryClass, cache, logs);
    }
    ...
    protected ComponentFactory factory(final SimpleContainer container,
        ...
        return (ComponentFactory) container.resolveComponent(factoryClass(), container.services().emptyContext(), traversal, reference).instance(traversal);
    }
}
