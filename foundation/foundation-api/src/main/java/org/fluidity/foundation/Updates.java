...
/**
 * Period updates facility. Components wishing to periodically update some data call {@link #register(long, Snapshot)} upon initialization and then should call
 * {@link Snapshot#get()} on the returned snapshot every time they wish to access the periodically updated data.
 * <p/>
 * This component is designed not to keep a hard reference to any object that registers for updates. Instead, the component keeps a hard reference to this
 * component.
 * <p/>
...
public interface Updates {
    ...
    String PERIOD_PROPERTY = "org.fluidity.foundation.updates.period.ms";

    /**
     * Registers an object to returned periodically updated data.
     * <p/>
    ...
    /**
     * Represents some data that may be periodically updated by the {@link Updates} component.
     *
    ...
    interface Snapshot<T> {
        ...
        /**
         * Returns an up-to-date version of the represented data.
         *
         * @return an up-to-date version of the represented data.
         */
        T get();
    }
